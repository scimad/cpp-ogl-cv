...
int main() {
    ...
    Texture texture_rl("../../../assets/chess/Chess_rlt45.svg.png");                          //https://commons.wikimedia.org/wiki/Category:SVG_chess_pieces
    Texture texture_qd("../../../assets/chess/Chess_qdt45.svg.png");
    texture_qd.bind();

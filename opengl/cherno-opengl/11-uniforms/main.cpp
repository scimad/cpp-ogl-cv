...
int main() {
    ...
    glBufferData(GL_ARRAY_BUFFER, 4 * 2 * sizeof(float), vertex_data, GL_STATIC_DRAW);
    ...
    ShaderProgramSource source = parseShader("../cherno-opengl/11-uniforms/res/basic.shader");
